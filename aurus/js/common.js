...
$(document).ready(function() {
	...
	$('#grid-view').click(function() {
		...
		if (cols == 2) {
			$('#content .product-list').attr('class', 'product-layout_cat product-grid col-lg-6 col-md-6 col-sm-12 col-xs-12');
		} else if (cols == 1) {
			$('#content .product-list').attr('class', 'product-layout_cat product-grid col-lg-3 col-md-4 col-sm-4 col-xs-12');
		} else {
			$('#content .product-list').attr('class', 'product-layout_cat product-grid col-lg-five col-md-3 col-sm-4 col-xs-12');
		}
